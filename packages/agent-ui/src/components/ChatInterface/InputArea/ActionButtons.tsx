 ...
 * @param {Object} props
 * @param {Function} props.onImageUpload - Callback when image upload button is clicked
 * @param {Function} props.onToggleCommandMenu - Callback when command menu button is clicked
 * @param {boolean} props.showCommandMenu - Whether command menu is visible
 * @param {number} props.commandCount - Number of available commands
 * @param {Function} props.onSubmit - Callback when send button is clicked
 * @param {boolean} props.isLoading - Whether request is loading
 * @param {boolean} props.hasInput - Whether input has content
 * @param {Function} props.onTranscript - Callback for voice transcript
 */
