...
function ToolUseDisplay({
  ...
  return (
    <div className="group relative bg-gradient-to-br from-blue-50/50 to-indigo-50/50 dark:from-blue-950/20 dark:to-indigo-950/20 border border-blue-100/30 dark:border-blue-800/30 rounded-lg p-3 mb-2">
      ...
      {/* Tool Input Display */}
      {message.toolInput && renderToolInput(message, autoExpandTools, showRawParameters, onFileOpen, selectedProject, createDiff)}

      {/* Tool Result Section */}
      {message.toolResult && renderToolResult(message, autoExpandTools, onFileOpen, selectedProject, createDiff)}
    </div>
  );
}

// Helper function to render tool-specific input
function renderToolInput(message, autoExpandTools, showRawParameters, onFileOpen, selectedProject, createDiff) {
  // Edit tool - show diff
...
function renderToolResultContent(message, autoExpandTools, onFileOpen, selectedProject, createDiff) {
